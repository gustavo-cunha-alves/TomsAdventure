...
public class Cenario2 extends JFrame {
	...
	public void init(){
		...
		timer.setCenario2(this);
		threadTimer = new Thread(timer);
		contentPane.add(timer);
		
		Icon imagemFundo = new ImageIcon(getClass().getResource("../images/Cenario2.jpg"));
		...
		JOptionPane.showMessageDialog(null,"Agora que já sabe como funciona, tente algo mais difícil!");
